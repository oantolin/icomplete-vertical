...
newline and to =icomplete-vertical-prospects-height=. The separator
should of course contain at least one newline, and it can have text
properties which control the display ---for example, you can apply
